...
medium.sound_speed_shear = ones(Nx,Ny,Nz) * 5; %201.74;          % [m/s]
medium.alpha_coeff_compression = ones(Nx,Ny,Nz) * 10;%0.5       % [10–3 m–1] 
medium.alpha_coeff_shear = ones(Nx,Ny,Nz) * 10;%500;             % [10–3 m–1] 
